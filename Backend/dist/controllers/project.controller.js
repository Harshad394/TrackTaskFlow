...
import { addProjectMemberSchema, createProjectSchema, updateProjectSchema, updateProjectMemberSchema, } from "../validators/project.validator.js";
const canManageOrganization = (organization, userId) => {
    return organization?.members.some((member) => member.userId.toString() === userId &&
...
export const addProjectMember = async (req, res) => {
    try {
        ...
        const existingMember = project.members.find((member) => member.userId.toString() === validatedData.userId);
        if (existingMember) {
